...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field 'floweringverbatim_ss', helper_method: 'render_flowering_calendar', label: 'Flowering Months'
    ...
    config.add_index_field 'floweringverbatim_ss', helper_method: 'render_flowering_calendar', label: 'Flowering Months'
